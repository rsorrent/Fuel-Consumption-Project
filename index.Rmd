...
<h4>On the basis of these results it has been possible to create this function in order to calculate the fuel consumption from the data on weight and horsepower given by the app user. 
...
<p>
<br>
<h5>On the main panel, the user can find the answer in term of miles per gallon.
